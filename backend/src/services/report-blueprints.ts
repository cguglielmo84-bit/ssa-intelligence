...
const industrialsSections: BlueprintSection[] = [
  ...
  { id: 'key_execs_and_board', title: 'Key Execs and Board Members', defaultSelected: true, focus: 'Board composition, C-suite leadership with manufacturing/operations focus.' },
...
const peSections: BlueprintSection[] = [
  ...
  { id: 'key_execs_and_board', title: 'Key Execs and Board Members', defaultSelected: false, focus: 'Partners, operating partners, and sponsor representatives.' },
...
const fsSections: BlueprintSection[] = [
  ...
  { id: 'key_execs_and_board', title: 'Key Execs and Board Members', defaultSelected: false, focus: 'Board composition, C-suite with risk/compliance leadership focus.' },
...
const insuranceSections: BlueprintSection[] = [
  ...
  { id: 'key_execs_and_board', title: 'Key Execs and Board Members', defaultSelected: false, focus: 'Board composition, C-suite with actuarial/underwriting leadership focus.' },
