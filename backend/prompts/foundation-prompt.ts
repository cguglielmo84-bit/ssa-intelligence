/**
 * Foundation Prompt Builder
 * Generates Phase 0 research prompt for Company Intelligence System
 * 
 * Usage:
 *   const prompt = buildFoundationPrompt({
 *     companyName: "Parker Hannifin",
 *     geography: "Germany",
 *     focusAreas: ["core segments", "priority offerings"],
 *     userFiles: [{name: "financials.xlsx", type: "Excel workbook"}]
 *   });
 */
...
// Returns the actual prompt string - the markdown prompt text above
// Usage:
// import { buildFoundationPrompt } from './foundation-prompt';
// const prompt = buildFoundationPrompt({ companyName: "Parker Hannifin", geography: "Germany" });
